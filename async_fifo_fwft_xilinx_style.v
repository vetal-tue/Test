...
// module async_fifo_fwft_xilinx_style #
// // module async_fifo_fwft_xilinx_style_full #
// (
//     parameter DATA_W = 16,
//     parameter ADDR_W = 4,
//     parameter ALMOST_FULL_THRESH  = (1<<ADDR_W) - 1,
...
//     wire do_shift = stage0_valid && (!stage1_valid || rd_en);
//     wire do_pop   = rd_en && stage1_valid;

//     // 🔥 ключевая правка
//     wire do_prefetch =
//         can_prefetch &&
//         ( !stage0_valid || do_shift );
...
//     // =====================================================
//     // USER READ POINTER (visible consumption)
//     // =====================================================
//     wire do_read = rd_en && stage1_valid;
